...
load = User.create(username: "load", email: "load@metallica.com", firstname: "load",
                   lastname: "metallica", password: "asd")
reload = User.create(username: "reload", email: "re@load.com", firstname: "re", lastname: "load",
                     password: "load")
killem_all = User.create(username: "killemall", email: "kill@emall.com", firstname: "kill",
                         lastname: "emall", password: "killem all")
master_of_puppets = User.create(username: "masterofpuppets", email: "master@master.com",
                                firstname: "master", lastname: "ofpupets",
                                password: "master of puppets")
ride_the_lightning = User.create(username: "ridethelightning", email: "ride@thelightning.com",
                                 firstname: "ride", lastname: "thelightning",
                                 password: "ride the lightning")
st_anger = User.create(username: "St.Anger", email: "anger@st.com", firstname: "St.",
                       lastname: "Anger", password: "anger")
